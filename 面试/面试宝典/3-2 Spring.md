...
对于AOP术语一开始看不明白，在网上搜了文章看，有一个解释让我茅塞顿开：连接点就是地铁的各个站点，切入点就是我要到的那个目的站点，通知就是我到站后要干什么。切入点+通知=切面，就是我要到哪个目的站干什么。
...
![img](3-2 Spring.assets/spring-1.jpg)
...
![img](3-2 Spring.assets/spring-2.png)
